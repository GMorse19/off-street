...
},
{
  ...
  imgId: '50',
  class: 'three flag-image2',
  description: <p>Brazilian Mahogany pallet coasters</p>,
  name: 'Pallet Coasters',
  price: '$30.00',
  src: process.env.PUBLIC_URL + '/Stock/palletCoasters.jpg',
},
{
  type: 'Item',
  style: 'pumpkin',
  ...
  imgId: '51',
  class: 'three flag-image2',
  description: <p>Oak Serving Tray</p>,
  name: 'Oak Serving Tray',
  price: '$50.00',
  src: process.env.PUBLIC_URL + '/Stock/servingTray.jpg',
},
{
  type: 'Item',
  style: 'pumpkin',
  ...
  imgId: '52',
  class: 'three flag-image2',
  description: <p>Toilet Paper Tower</p>,
  name: 'Toilet Paper Tower',
  price: '$109.00',
  src: process.env.PUBLIC_URL + '/Stock/tpHolder.jpeg',
},
{
  type: 'Item',
  style: 'pumpkin',
  ...
  imgId: '53',
  class: 'three flag-image2',
  description: <p>Cedar Tag</p>,
  name: 'Cedar Tag',
  price: '$109.00',
  src: process.env.PUBLIC_URL + '/Stock/cedarTag.jpeg',
},
{
  type: 'Item',
  style: 'pumpkin',
  ...
  imgId: '54',
  class: 'three flag-image2',
  description: <p>Rustic Vertical American Flag Wall Art – Torched Frame</p>,
  name: 'Patriotic Wall Art',
  price: '$109.00',
  src: process.env.PUBLIC_URL + '/Stock/verticalBurnt.jpeg',
},
{
  type: 'Item',
  style: 'pumpkin',
  ...
  imgId: '55',
  class: 'three flag-image2',
  description: <p>Rustic Vertical American Flag Wall Art – Red Frame</p>,
  name: 'Patriotic Wall Art',
  price: '$109.00',
  src: process.env.PUBLIC_URL + '/Stock/verticalRed.jpeg',
},
{
  type: 'Item',
  style: 'bottle opener',
...
},
{
  ...
  class: 'four flag-image2',
  name: '617 Irish',
  src: process.env.PUBLIC_URL + '/Stock/etsy/Irish617.JPG',
},
{
  type: 'Item',
  style: 'standard',
  ...
  class: 'four flag-image2',
  name: '617 Patriotic',
  src: process.env.PUBLIC_URL + '/Stock/etsy/Patriotic617.JPG',
},
{
  type: 'Item',
  style: 'standard',
  ...
  imgId: '103',
  class: 'four flag-image2',
  name: 'Burnt Vertical Wall Hanging',
  src: process.env.PUBLIC_URL + '/Stock/etsy/BurntVertical.jpeg',
},
{
  type: 'Item',
  style: 'standard',
  ...
  imgId: '104',
  class: 'four flag-image2',
  name: 'Red Vertical Wall Hanging',
  src: process.env.PUBLIC_URL + '/Stock/etsy/RedVertical.jpeg',
},
{
  type: 'Item',
  style: 'standard',
  ...
  src: process.env.PUBLIC_URL + '/Stock/etsy/Fish.jpg',
},
{
  type: 'Item',
  style: 'standard',
  ...
  class: 'four flag-image2',
  name: 'Mini Pumkins',
  src: process.env.PUBLIC_URL + '/Stock/etsy/Pumkins.jpg',
},
{
  type: 'Item',
  style: 'standard',
  ...
  imgId: '107',
  class: 'four flag-image2',
  name: 'Patriotic Wall Hanging',
  src: process.env.PUBLIC_URL + '/Stock/etsy/SkinnyVertical.jpeg',
},
{
  type: 'Item',
  style: 'standard',
  ...
  imgId: '108',
  class: 'four flag-image2',
  name: 'Rustic Tissue Box',
  src: process.env.PUBLIC_URL + '/Stock/etsy/Tissue.jpg',
},
{
  type: 'Item',
  style: 'standard',
  ...
  imgId: '109',
  class: 'four flag-image2',
  name: 'Rustic Wood Pumkin',
  src: process.env.PUBLIC_URL + '/Stock/etsy/WoodPumpkin.jpg',
},
{
  type: 'Item',
  style: 'standard',
  ...
  class: 'four flag-image2',
  name: 'Steam Punk-in',
  src: process.env.PUBLIC_URL + '/Stock/etsy/SteamPunkin.jpg',
},
{
  type: 'Item',
  style: 'standard',
  ...
  imgId: '111',
  class: 'four flag-image2',
  name: 'Mini Wooden Coffin',
  src: process.env.PUBLIC_URL + '/Stock/etsy/Coffin.jpg',
},
]
